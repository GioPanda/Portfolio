      ...
      <div className={`${styles.containerOtherPage} newSection`} id="About">
        ...
        <div className={styles.wrapper}>
          <div className={styles.text}>
            <p>
              Me chamo Giovanna Santos. sou uma desenvolvedora front-end
              apaixonada pela criação de experiências web excepcionais. Minha
              jornada na programação começou aos 12 anos, inicialmente
              explorando o mundo do PHP. Em 2022, decidi retomar minha jornada,
              mas desta vez com foco em JavaScript/TypeScript e React.
            </p>
            <p>
